...
int main(int argc, char **argv)
{
    ...
    robotTool rt;
	// 移动机械臂到检测位置
	arm.move_j(std::vector<double>{rt.degreesToRadians(0), rt.degreesToRadians(-30), rt.degreesToRadians(-90),
											 rt.degreesToRadians(0), rt.degreesToRadians(-60), rt.degreesToRadians(-180)});
