...
class GraspServer:
    ...
    def sensor_cb(self, msg):
        if self.integrate:
            ...
            extrinsic = tf.lookup(
                self.cam_frame_id, self.frame_id, msg.header.stamp, rospy.Duration(
                    0.1)
            )
    ...
    def get_scene_cloud(self, req):
        ...
        msg = to_cloud_msg(self.cam_frame_id, points)
    ...
    def get_map_cloud(self, req):
        ...
        msg = to_cloud_msg(self.cam_frame_id, points, distances=distances)
